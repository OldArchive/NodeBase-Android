package nodebase.org.nodebasewallet.ui.crash_activity;
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String authorities = "nodebase.org.nodebasewallet.myfileprovider";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nodebaseApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    protected CharSequence subject(){
        return "Crash report"+" "+ nodebaseApplication.getVersionName();
    }
    ...
    protected CharSequence collectWalletDump() throws IOException{
        return ((NodeBaseModuleImp)nodebaseApplication.getModule()).getWallet().toString(false,true,true,null);
    }
}
