package nodebase.org.nodebasewallet.ui.export_account;
...
import nodebase.org.nodebasewallet.utils.AndroidUtils;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = nodebaseModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(NodeBaseContext.NETWORK_PARAMETERS);
