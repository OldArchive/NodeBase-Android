package nodebase.org.nodebasewallet.ui.import_watch_only;
...
import static nodebase.org.nodebasewallet.utils.CrashReporter.appendSavedBackgroundTraces;
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length()>0){
            try {
                nodebaseModule.watchOnlyMode(
                        xpub,
                        isBip32 ? DeterministicKeyChain.KeyChainType.BIP32: DeterministicKeyChain.KeyChainType.BIP44_NDB_ONLY
                );
