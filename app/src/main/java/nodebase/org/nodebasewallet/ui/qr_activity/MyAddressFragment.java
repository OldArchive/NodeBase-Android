...
import static nodebase.org.nodebasewallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(NodeBaseModule nodebaseModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(nodebaseModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = NodeBaseApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String nodebaseUri = SendURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(nodebaseUri,address.toBase58());
            }
    ...
    public void setModule(NodeBaseModule module) {
        this.module = module;
    }
