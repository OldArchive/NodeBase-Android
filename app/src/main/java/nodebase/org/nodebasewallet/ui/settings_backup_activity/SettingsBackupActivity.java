package nodebase.org.nodebasewallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = nodebaseModule.backupWallet(backupFile, firstPassword);

            if (result){
                nodebaseApplication.getAppConf().setHasBackup(true);
