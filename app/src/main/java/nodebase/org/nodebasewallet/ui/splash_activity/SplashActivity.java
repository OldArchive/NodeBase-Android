package nodebase.org.nodebasewallet.ui.splash_activity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri video;
        if(NodeBaseApplication.getInstance().getAppConf().isSplashSoundEnabled())
    ...
    private void jump() {
        ...
        if (NodeBaseApplication.getInstance().getAppConf().isAppInit()){
            Intent intent = new Intent(this, WalletActivity.class);
            startActivity(intent);
        }else {
