package nodebase.org.nodebasewallet.ui.start_node_activity;
...
import nodebase.org.nodebasewallet.ui.pincode_activity.PincodeActivity;
import nodebase.org.nodebasewallet.ui.wallet_activity.WalletActivity;
import nodebase.org.nodebasewallet.utils.DialogBuilder;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        findViewById(R.id.btn_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Check this..
                nodebaseApplication.setTrustedServer(trustedNodes.get(3));
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = nodebaseApplication.getAppConf().getTrustedNode()!=null;
                nodebaseApplication.setTrustedServer(selectedNode);
        ...
        PivtrumPeerData pivtrumPeer = nodebaseApplication.getAppConf().getTrustedNode();
