package nodebase.org.nodebasewallet.ui.transaction_request_activity;
...
import nodebase.org.nodebasewallet.ui.transaction_send_activity.AmountInputFragment;
import nodebase.org.nodebasewallet.utils.DialogsUtil;
import nodebase.org.nodebasewallet.utils.NavigationUtils;

import static android.graphics.Color.WHITE;
import static nodebase.org.nodebasewallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static nodebase.org.nodebasewallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = nodebaseModule.getFreshNewAddress().toBase58();

        NetworkParameters params = nodebaseModule.getConf().getNetworkParams();

        String nodebaseURI = SendURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(nodebaseURI);
        qrDialog.setQrText(nodebaseURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String nodebaseURI) throws WriterException {
