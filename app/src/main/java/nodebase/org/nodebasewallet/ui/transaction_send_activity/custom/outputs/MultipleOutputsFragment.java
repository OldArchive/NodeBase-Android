package nodebase.org.nodebasewallet.ui.transaction_send_activity.custom.outputs;
...
public class MultipleOutputsFragment extends BaseRecyclerFragment<OutputWrapper> {
        ...
        adapter = new BaseRecyclerAdapter<OutputWrapper, OutputHolder>(getActivity()) {
            ...
            protected void bindHolder(final OutputHolder holder, final OutputWrapper data, final int position) {
                ...
                if (data.getAddress()!=null){
                    ...
                    if (!nodebaseModule.chechAddress(data.getAddress())) {
                        ...
                        if (s.length()>0){
                            if (holder.edit_address!=null) {
                                ...
                                if (!nodebaseModule.chechAddress(address)) {
                                    ...
                                    AddressLabel addressLabel = nodebaseModule.getAddressLabel(address);
    ...
    public void addOutput(){
        ...
        if (address==null || !nodebaseModule.chechAddress(address)){
            // todo: mejorar esto
    ...
    public List<OutputWrapper> getList() throws InvalidFieldException {
        ...
        for (int i=0;i<list.size();i++){
            ...
            boolean checkAddress = address==null || !nodebaseModule.chechAddress(address);
