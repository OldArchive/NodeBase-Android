package nodebase.org.nodebasewallet.ui.words_restore_activity;
...
import nodebase.org.nodebasewallet.ui.transaction_send_activity.MyFilterableAdapter;
import nodebase.org.nodebasewallet.ui.transaction_send_activity.MyTextWatcher;
...
import static nodebase.org.nodebasewallet.module.NodeBaseContext.NodeBase_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = nodebaseModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            nodebaseModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            nodebaseModule.restoreWallet(mnemonic, NodeBase_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (nodebaseApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!nodebaseApplication.getAppConf().isAppInit()){
                                                            nodebaseApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, NodeBaseContext.ENABLE_BIP44_APP_VERSION));
