...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final NodeBaseApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (NodeBaseContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + NodeBaseContext.NETWORK_PARAMETERS.getId() + "\n");
		final Wallet wallet = ((NodeBaseModuleImp)application.getModule()).getWallet();
