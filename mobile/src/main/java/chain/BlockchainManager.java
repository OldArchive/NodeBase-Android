...
import org.nodebasej.core.CheckpointManager;
...
import org.nodebasej.core.StoredBlock;
import org.nodebasej.core.Transaction;
import org.nodebasej.core.TransactionBroadcast;
...
import org.nodebasej.net.discovery.MultiplexingDiscovery;
import org.nodebasej.net.discovery.PeerDiscovery;
import org.nodebasej.net.discovery.PeerDiscoveryException;
                        ...
                        public InetSocketAddress[] getPeers(final long services, final long timeoutValue, final TimeUnit timeoutUnit)
                            ...
                            if (hasTrustedPeer) {
                                ...
                                if (trustedPeerHost.equals(FURSZY_TESTNET_SERVER) && !conf.isTest()){
                                    addr = new InetSocketAddress(trustedPeerHost, CoinDefinition.Port);
                                }else {
