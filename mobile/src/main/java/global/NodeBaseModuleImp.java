...
import org.nodebasej.core.Sha256Hash;
...
import org.nodebasej.crypto.DeterministicKey;
import org.nodebasej.crypto.KeyCrypter;
import org.nodebasej.crypto.MnemonicException;
import org.nodebasej.script.Script;
import org.nodebasej.wallet.DeterministicKeyChain;
...
import global.nodebase.DefaultCoinSelector;
...
public class NodeBaseModuleImp implements NodeBaseModule {

    private static final Logger logger = LoggerFactory.getLogger(NodeBaseModuleImp.class);
    ...
    public NodeBaseModuleImp(ContextWrapper contextWrapper, WalletConfiguration walletConfiguration,ContactsStoreDao contactsStore,RateDbDao rateDb,BackupHelper backupHelper) {
...
//    }
    ...
    public Transaction completeTxWithCustomFee(Transaction transaction,Coin fee) throws InsufficientMoneyException{
        ...
        walletManager.completeSend(sendRequest);
        // if the fee is different to the custom fee and the tx size is lower than 1kb (1000 bytes in nodebase core)
...
//                    }
    ...
    public NodeBaseRate getRate(String coin) {
   ...
   public boolean isSyncWithNode() throws NoPeerConnectedException {
    ...
    @Override
    public List<NodeBaseRate> listRates() {
        return rateDb.list();
    }
    ...
    public void saveRate(NodeBaseRate nodebaseRate){
        rateDb.insertOrUpdateIfExist(nodebaseRate);
    }
